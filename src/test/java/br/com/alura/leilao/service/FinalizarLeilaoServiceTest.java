...
class FinalizarLeilaoServiceTest {
	...
	@Mock
	private EnviadorDeEmails eviadorDeEmails;

	@BeforeEach
	public void beforeEach() {
		MockitoAnnotations.initMocks(this);
		this.service = new FinalizarLeilaoService(leilaoDao, eviadorDeEmails);
	}
	...
	void deveriaEnviarEmailParaVencedorDoLeilao() {
		...
		Mockito.verify(eviadorDeEmails).enviarEmailVencedorLeilao(lanceVencedor);
	...
	void naoDeveriaEnviarEmailParaVEncedorDoLeilaoEmCasoDeErroEncerrarOLeilao() {
		...
		try {
			service.finalizarLeiloesExpirados();
			Mockito.verifyNoInteractions(eviadorDeEmails);
		} catch (Exception e) {
		}
